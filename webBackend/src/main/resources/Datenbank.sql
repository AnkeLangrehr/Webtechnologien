...
--
-- Tabellenstruktur für Tabelle `album_seq`
--
...
--
-- Daten für Tabelle `album_seq`
--

INSERT INTO `album_seq` (`next_val`) VALUES
(1);
...
INSERT INTO `app_user` (`id`, `first_name`, `last_name`, `login`, `password`) VALUES
(1, 'Anke', 'Langrehr', 'testUser', '$2a$10$kZD.jakgxn.ryOuqTur6ieLP35Q9fTC9I6hSSfuFvUJ76PItNxtpW');
...
INSERT INTO `artist` (`id`, `record_label_id`, `name`, `image_link`) VALUES
(1, 1, 'Metallica', 'https://images.universal-music.de/img/assets/580/580155/195/metallicapng.png'),
(2, 1, 'Megadeth', 'https://www.laut.de/Megadeth/megadeth-167223.jpg'),
(3, 1, 'Anthrax', 'https://www.rocks-magazin.de/sites/default/files/styles/header_gross_skaliert_489/public/articles/anthrax-band-2018-NYC-skyline-rocks-837x489.jpg?itok=i3POL-HS'),
(4, 2, 'Eric Clapton', 'https://i0.web.de/image/346/37122346,pd=2,f=sdata11/eric-clapton.jpg'),
(5, 2, 'ZZ Top', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/ZZ_Top_Live.jpg/1200px-ZZ_Top_Live.jpg'),
...
(8, 3, 'AC/DC', 'https://www.swp.de/imgs/07/1/2/8/1/1/8/7/9/7/tok_934e63cfe1250cca59a6bfb1891f0aec/w1200_h675_x750_y474_53594149.jpg-0860cece8a0d2151.jpeg'),
(9, 6, 'The Beatles', 'https://www1.wdr.de/radio/wdr5/beatles122~_v-gseaclassicxl.jpg');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `artist_seq`
--

CREATE TABLE `artist_seq` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Daten für Tabelle `artist_seq`
--

INSERT INTO `artist_seq` (`next_val`) VALUES
(1);
...
--
-- Tabellenstruktur für Tabelle `playlistalt`
--

CREATE TABLE `playlistalt` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `owner_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `playlist_seq`
--

CREATE TABLE `playlist_seq` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Daten für Tabelle `playlist_seq`
--

INSERT INTO `playlist_seq` (`next_val`) VALUES
(1);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `playlist_songs`
--
...
--
-- Tabellenstruktur für Tabelle `playlist_sons`
--

CREATE TABLE `playlist_sons` (
  `playlist_id` int(11) NOT NULL,
  `song_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `record_label_seq`
--

CREATE TABLE `record_label_seq` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Daten für Tabelle `record_label_seq`
--

INSERT INTO `record_label_seq` (`next_val`) VALUES
(1);
...
--
-- Tabellenstruktur für Tabelle `song_seq`
--
...
--
-- Daten für Tabelle `song_seq`
--

INSERT INTO `song_seq` (`next_val`) VALUES
(1);
...
INSERT INTO `user` (`id`, `email`, `name`, `role`, `password`, `last_name`, `login`, `username`) VALUES
(202, 'testUser@test.de', NULL, NULL, '$2a$10$k5a5YvEL2m8eGdEH.sjkdOB3/cE/Dkt7XC/hchbM06c3fQFRvaHEW', NULL, NULL, 'testUser@test.de'),
(203, 'testUser@testuser.de', NULL, NULL, '$2a$10$Uze.HefpAGsr9jNBYpklyug7cYsMZEAMyAUXYdw2pImZyrRo7V5Tq', NULL, NULL, 'testUser@testuser.de');
...
--
-- Indizes für die Tabelle `app_user`
--
...
ALTER TABLE `playlist`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_ojsagwjitvw5gdft4qxf7dqp2` (`owner_id`);

--
-- Indizes für die Tabelle `playlistalt`
--
ALTER TABLE `playlistalt`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_ojsagwjitvw5gdft4qxf7dqp2` (`owner_id`);

--
-- Indizes für die Tabelle `playlist_songs`
--
ALTER TABLE `playlist_songs`
  ADD PRIMARY KEY (`playlist_id`,`song_id`),
  ADD KEY `FKeoq351es4umfqqey74cbgrji3` (`song_id`);

--
-- Indizes für die Tabelle `playlist_sons`
--
ALTER TABLE `playlist_sons`
  ADD PRIMARY KEY (`playlist_id`,`song_id`),
  ADD KEY `FKgr1y8bhh6e4inf0xji3s7u1nh` (`song_id`);

--
-- Indizes für die Tabelle `record_label`
--
...
ALTER TABLE `song`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_s26p4wlmwakdj7ajdv4vee6n8` (`album_id`);
...
--
-- AUTO_INCREMENT für Tabelle `app_user`
--
ALTER TABLE `app_user`
...
--
-- AUTO_INCREMENT für Tabelle `user_details`
--
ALTER TABLE `user_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `artist`
  ADD CONSTRAINT `FKa3k6g97wyskvy59xm3ur0ophv` FOREIGN KEY (`record_label_id`) REFERENCES `record_label` (`id`),
  ADD CONSTRAINT `fk_record_label_in_artist` FOREIGN KEY (`record_label_id`) REFERENCES `record_label` (`id`);

--
-- Constraints der Tabelle `playlistalt`
--
ALTER TABLE `playlistalt`
  ADD CONSTRAINT `FKth9shh6b71k2k9f8sdtuedunf` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`);

--
-- Constraints der Tabelle `playlist_songs`
--
ALTER TABLE `playlist_songs`
  ADD CONSTRAINT `FKeoq351es4umfqqey74cbgrji3` FOREIGN KEY (`song_id`) REFERENCES `song` (`id`),
  ADD CONSTRAINT `FKf5rt0kg266cdttc1xucp6dpg8` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`);

--
-- Constraints der Tabelle `playlist_sons`
--
ALTER TABLE `playlist_sons`
  ADD CONSTRAINT `FKeo3fjmlflm4ps5ov1baswx2wb` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`),
  ADD CONSTRAINT `FKgr1y8bhh6e4inf0xji3s7u1nh` FOREIGN KEY (`song_id`) REFERENCES `song` (`id`);
